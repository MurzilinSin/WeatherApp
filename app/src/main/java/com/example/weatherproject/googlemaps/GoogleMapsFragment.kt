package com.example.weatherproject.googlemaps
...
import com.example.weatherproject.databinding.FragmentGoogleMapsBinding
...
//AIzaSyDbj4YudQFE1xaGij4jlQV6lmrXILHvFNA
...
class GoogleMapsFragment : Fragment() {
    ...
    private fun goToAddress(addresses: MutableList<Address>, view: View, searchText: String) {
        val location = LatLng(addresses[0].latitude,
